...
<div class="login-box">
    <h2>Edit Client</h2>
    <form method="post">
        <div class="user-box"><input type="text" name="emri" required="" value="<?php if (!empty($client1->getEmri())) {
                                                                                    echo $client1->getEmri();
        ...
        <div class="user-box"><input type="number" name="numriTel" required="" value="<?php if (!empty($client1->getNumriTel())) {
                                                                                        ...
                                                                                        } ?>"><label>Numri Telefonit:</label></div>
        <input class="update1" type="submit" value="Delete Customer" name="delete">
